    ...
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      <div className="relative overflow-hidden shadow-mb pb-80 mb-6">
        ...
        />
           ...
           <div className="block lg:flex text-center items-center justify-center -8 w-full">
              <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
                  ...
                  />
                  <p className="ml-1 inline align-middle text-gray-700">{post.authors[0].name}</p>
           ...
           <p className="text-center text-lg text-gray-700 font-normal mt-4 px-4 lg: px-20 mb-8">{post.excerpt}</p>
